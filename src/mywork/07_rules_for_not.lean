...
begin
assume h,
cases h with p np, -- cases is an automatic eliminator, shows the different cases possible, with keyword allows you to assign names to the different cases
exact (nx, x) --apply generally won't work where exact works
end
